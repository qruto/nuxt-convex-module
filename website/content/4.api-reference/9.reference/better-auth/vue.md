...
| ------ | ------ | ------ | ------ |
| <a id="isloading"></a> `isLoading` | `ComputedRef`\<`boolean`\> | - | src/runtime/better-auth/vue/use-auth.ts:37 |
| <a id="isauthenticated"></a> `isAuthenticated` | `ComputedRef`\<`boolean`\> | - | src/runtime/better-auth/vue/use-auth.ts:38 |
| <a id="fetchaccesstoken"></a> `fetchAccessToken` | [`AuthTokenFetcher`](/api-reference/reference/vue#authtokenfetcher) | - | src/runtime/better-auth/vue/use-auth.ts:39 |
| <a id="client"></a> `client` | [`AuthClient`](#authclient) | - | src/runtime/better-auth/vue/use-auth.ts:41 |
| <a id="session"></a> `session` | [`AuthSession`](#authsession) | - | src/runtime/better-auth/vue/use-auth.ts:42 |
| <a id="user"></a> `user` | `ComputedRef`\<[`AuthUser`](#authuser) \| `null`\> | The current user, or `null` when signed out / still loading. | src/runtime/better-auth/vue/use-auth.ts:44 |
| <a id="authversion"></a> `authVersion` | `ComputedRef`\<`string` \| `null`\> | - | src/runtime/better-auth/vue/use-auth.ts:45 |
| <a id="signout"></a> `signOut` | () => `Promise`\<`unknown`\> | Sign the current user out. | src/runtime/better-auth/vue/use-auth.ts:47 |
| <a id="sendotp"></a> `sendOtp` | (`email`, `type?`) => `Promise`\<`unknown`\> | Send a sign-in / verification OTP code to an email. | src/runtime/better-auth/vue/use-auth.ts:49 |
| <a id="signinwithotp"></a> `signInWithOtp` | (`args`) => `Promise`\<`unknown`\> | Complete sign-in (or passwordless sign-up) with an emailed OTP code. | src/runtime/better-auth/vue/use-auth.ts:51 |
| <a id="signinwithpasskey"></a> `signInWithPasskey` | () => `Promise`\<`unknown`\> | Sign in with a passkey (WebAuthn). | src/runtime/better-auth/vue/use-auth.ts:53 |
| <a id="registerpasskey"></a> `registerPasskey` | (`context?`) => `Promise`\<`unknown`\> | Register a passkey — pass `{ email, name }` (JSON) for pre-auth registration. | src/runtime/better-auth/vue/use-auth.ts:55 |
| <a id="changeemail"></a> `changeEmail` | (`newEmail`, `callbackURL?`) => `Promise`\<`unknown`\> | Change the account email (confirmed via email). | src/runtime/better-auth/vue/use-auth.ts:57 |
| <a id="deleteaccount"></a> `deleteAccount` | () => `Promise`\<`unknown`\> | Delete the account (confirmed via email). | src/runtime/better-auth/vue/use-auth.ts:59 |
...
Defined in: src/runtime/better-auth/vue/use-auth.ts:33
...
| ------ | ------ | ------ |
| `id` | `string` | src/runtime/better-auth/vue/use-auth.ts:33 |
| `email` | `string` | src/runtime/better-auth/vue/use-auth.ts:33 |
| `name` | `string` | src/runtime/better-auth/vue/use-auth.ts:33 |
...
Defined in: src/runtime/better-auth/vue/auth-boundary.ts:66
...
Defined in: src/runtime/better-auth/vue/cross-domain.ts:29
...
Defined in: src/runtime/better-auth/vue/hydration.ts:64
...
Defined in: src/runtime/better-auth/vue/use-auth.ts:71
