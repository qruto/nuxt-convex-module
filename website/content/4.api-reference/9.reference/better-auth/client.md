...
Defined in: [src/runtime/better-auth/vue/auth-boundary.ts:80](https://github.com/qruto/nuxt-convex-module/blob/main/src/runtime/better-auth/vue/auth-boundary.ts#L80)
