...
Defined in: src/runtime/vue/client.ts:191
...
Defined in: src/runtime/vue/client.ts:212
...
Defined in: src/runtime/vue/client.ts:250
...
Defined in: src/runtime/vue/client.ts:576
...
Defined in: src/runtime/vue/client.ts:292
...
Defined in: src/runtime/vue/client.ts:316
...
Defined in: src/runtime/vue/client.ts:350
...
Defined in: src/runtime/vue/client.ts:428
...
Defined in: src/runtime/vue/client.ts:479
...
Defined in: src/runtime/vue/client.ts:500
...
Defined in: src/runtime/vue/client.ts:520
...
Defined in: src/runtime/vue/client.ts:549

Get the current [ConnectionState](#connectionstate-1) between the client and the Convex
backend.
...
The [ConnectionState](#connectionstate-1) with the Convex backend.
...
Defined in: src/runtime/vue/client.ts:565

Subscribe to the [ConnectionState](#connectionstate-1) between the client and the Convex
...
Defined in: src/runtime/vue/client.ts:588
...
Defined in: src/runtime/vue/auth/index.ts:74
...
| ------ | ------ | ------ |
| <a id="client"></a> `client` | [`IConvexVueClient`](#iconvexvueclient) | src/runtime/vue/auth/index.ts:75 |
| <a id="useauth"></a> `useAuth` | () => \{ `isLoading`: `MaybeRefOrGetter`\<`boolean`\>; `isAuthenticated`: `MaybeRefOrGetter`\<`boolean`\>; `fetchAccessToken`: `MaybeRef`\<[`AuthTokenFetcher`](#authtokenfetcher)\>; `authVersion?`: `unknown`; \} | src/runtime/vue/auth/index.ts:76 |
...
Defined in: src/runtime/vue/client.ts:63
...
Defined in: src/runtime/vue/client.ts:73
...
Defined in: src/runtime/vue/client.ts:95
...
| ------ | ------ | ------ | ------ |
| <a id="journal-1"></a> `journal?` | [`QueryJournal`](#queryjournal) | An (optional) journal produced from a previous execution of this query function. If there is an existing subscription to a query function with the same name and arguments, this journal will have no effect. | src/runtime/vue/client.ts:103 |

***

### MutationOptions

Defined in: src/runtime/vue/client.ts:116
...
| Property | Type | Description | Defined in |
| ------ | ------ | ------ | ------ |
| <a id="optimisticupdate"></a> `optimisticUpdate?` | [`OptimisticUpdate`](#optimisticupdate-1)\<`Args`\> | An optimistic update to apply along with this mutation. An optimistic update locally updates queries while a mutation is pending. Once the mutation completes, the update will be rolled back. | src/runtime/vue/client.ts:123 |

***

### ConvexVueClientOptions

Defined in: src/runtime/vue/client.ts:140
...
Defined in: src/runtime/vue/composables/use-action.ts:11
...
Defined in: src/runtime/vue/composables/use-action.ts:19
...
Defined in: src/runtime/vue/composables/use-mutation.ts:14
...
Defined in: src/runtime/vue/composables/use-mutation.ts:21
...
Defined in: src/runtime/vue/composables/use-mutation.ts:44
...
| Type Parameter |
| ------ |
| `T` *extends* [`OptimisticUpdate`](#optimisticupdate-1)\<[`FunctionArgs`](#functionargs)\<`Mutation`\>\> |
...
| <a id="status-1"></a> `status` | [`UploadItemStatus`](#uploaditemstatus) | Current upload status. | src/runtime/vue/composables/use-upload-queue.ts:23 |
...
Defined in: src/runtime/vue/auth/index.ts:8
...
Defined in: src/runtime/vue/auth/index.ts:9
...
Defined in: src/runtime/vue/auth/index.ts:14
...
Defined in: src/runtime/vue/auth/index.ts:34
...
| Property | Type | Defined in |
| ------ | ------ | ------ |
| <a id="isloading"></a> `isLoading` | `ComputedRef`\<`boolean`\> | src/runtime/vue/auth/index.ts:35 |
| <a id="isauthenticated"></a> `isAuthenticated` | `ComputedRef`\<`boolean`\> | src/runtime/vue/auth/index.ts:36 |
| <a id="isrefreshing"></a> `isRefreshing` | `ComputedRef`\<`boolean`\> | src/runtime/vue/auth/index.ts:37 |
...
Defined in: src/runtime/vue/client.ts:129
...
Defined in: src/runtime/vue/client.ts:148
...
Defined in: src/runtime/vue/composables/use-paginated-query.ts:526
...
| Property | Type | Description | Defined in |
| ------ | ------ | ------ | ------ |
| <a id="results"></a> `results` | `ComputedRef`\<[`PaginatedQueryItem`](#paginatedqueryitem)\<`Query`\>[]\> | - | src/runtime/vue/composables/use-paginated-query.ts:527 |
| <a id="status"></a> `status` | `ComputedRef`\<[`PaginationStatus`](#paginationstatus)\> | - | src/runtime/vue/composables/use-paginated-query.ts:528 |
| <a id="isloading-1"></a> `isLoading` | `ComputedRef`\<`boolean`\> | - | src/runtime/vue/composables/use-paginated-query.ts:529 |
| <a id="loadmore"></a> `loadMore` | (`numItems`) => `void` | Fetch `numItems` more results. Stable across state changes; only fetches when `status` is `'CanLoadMore'` (matching the documented semantics). | src/runtime/vue/composables/use-paginated-query.ts:534 |
...
Defined in: src/runtime/vue/composables/use-query.ts:16
...
Defined in: src/runtime/vue/composables/use-query.ts:26
...
Defined in: src/runtime/vue/hydration.ts:14
...
| Property | Type | Defined in |
| ------ | ------ | ------ |
| <a id="__type-8"></a> `__type` | `Query` | src/runtime/vue/hydration.ts:15 |
| <a id="_name"></a> `_name` | `string` | src/runtime/vue/hydration.ts:16 |
| <a id="_argsjson"></a> `_argsJSON` | `string` | src/runtime/vue/hydration.ts:17 |
| <a id="_valuejson"></a> `_valueJSON` | `string` | src/runtime/vue/hydration.ts:18 |
...
| Property | Type | Description | Defined in |
| ------ | ------ | ------ | ------ |
| <a id="query-4"></a> `query` | `Query` | The query function to run. | node\_modules/convex/dist/esm-types/browser/query\_options.d.ts:13 |
| <a id="args-2"></a> `args` | [`FunctionArgs`](#functionargs)\<`Query`\> | The arguments to the query function. | node\_modules/convex/dist/esm-types/browser/query\_options.d.ts:17 |
...
| <a id="args-4"></a> `args` | [`PaginatedQueryArgs`](#paginatedqueryargs)\<`Query`\> \| `"skip"` | - | node\_modules/convex/dist/esm-types/react/use\_paginated\_query2.d.ts:9 |
...
Defined in: src/runtime/vue/auth/helpers.ts:41
...
Defined in: src/runtime/vue/auth/helpers.ts:67
...
Defined in: src/runtime/vue/auth/helpers.ts:98
...
Defined in: src/runtime/vue/auth/index.ts:41
...
Defined in: src/runtime/vue/client.ts:619
...
Defined in: src/runtime/vue/composables/use-action.ts:90
...
Defined in: src/runtime/vue/composables/use-mutation.ts:129
...
Defined in: src/runtime/vue/composables/use-paginated-query.ts:542
...
Defined in: src/runtime/vue/composables/use-queries.ts:128
...
Defined in: src/runtime/vue/composables/use-query.ts:207
...
Defined in: src/runtime/vue/auth/index.ts:53
...
| Name | Type | Defined in |
| ------ | ------ | ------ |
| `isLoading` | `ComputedRef`\<`boolean`\> | src/runtime/vue/auth/index.ts:54 |
| `isAuthenticated` | `ComputedRef`\<`boolean`\> | src/runtime/vue/auth/index.ts:55 |
| `isRefreshing` | `ComputedRef`\<`boolean`\> | src/runtime/vue/auth/index.ts:56 |
...
Defined in: src/runtime/vue/auth/index.ts:131
...
Defined in: src/runtime/vue/auth/index.ts:148
...
Defined in: src/runtime/vue/auth/index.ts:278
...
| Name | Type | Defined in |
| ------ | ------ | ------ |
| `state` | [`ConvexAuthState`](#convexauthstate) | src/runtime/vue/auth/index.ts:280 |
| `scope` | `EffectScope` | src/runtime/vue/auth/index.ts:280 |
...
Defined in: src/runtime/vue/client.ts:631
...
Defined in: src/runtime/vue/composables/use-action.ts:74
...
Defined in: src/runtime/vue/composables/use-connection-state.ts:33

Vue composable to get the current [ConnectionState](#connectionstate-1) and subscribe to changes.
...
The current [ConnectionState](#connectionstate-1) with the Convex backend.
...
Defined in: src/runtime/vue/composables/use-mutation.ts:113
...
Defined in: src/runtime/vue/composables/use-paginated-query.ts:204
...
Defined in: src/runtime/vue/composables/use-paginated-query.ts:549
...
Defined in: src/runtime/vue/composables/use-paginated-query.ts:591
...
Defined in: src/runtime/vue/composables/use-paginated-query.ts:619
...
Defined in: src/runtime/vue/composables/use-paginated-query.ts:658
...
Defined in: src/runtime/vue/composables/use-paginated-query.ts:860
...
Defined in: src/runtime/vue/composables/use-paginated-query.ts:866
...
Defined in: src/runtime/vue/composables/use-queries.ts:60
...
Defined in: src/runtime/vue/composables/use-query.ts:77
...
Defined in: src/runtime/vue/composables/use-query.ts:143
...
Defined in: src/runtime/vue/hydration.ts:51
