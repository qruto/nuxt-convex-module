...
Defined in: src/runtime/polar/vue/components.ts:38
...
| ------ | ------ | ------ |
| <a id="generatecheckoutlink"></a> `generateCheckoutLink?` | [`FunctionReference`](/api-reference/reference/vue#functionreference)\<`"action"`, `"public"`, [`CheckoutArgs`](#checkoutargs), \{ `url`: `string`; \}\> | src/runtime/polar/vue/components.ts:39 |
| <a id="generatecustomerportalurl"></a> `generateCustomerPortalUrl?` | [`FunctionReference`](/api-reference/reference/vue#functionreference)\<`"action"`, `"public"`, \{ `returnUrl?`: `string`; \}, \{ `url`: `string`; \}\> | src/runtime/polar/vue/components.ts:40 |
...
Defined in: src/runtime/polar/vue/components.ts:49
...
Defined in: src/runtime/polar/vue/components.ts:100
