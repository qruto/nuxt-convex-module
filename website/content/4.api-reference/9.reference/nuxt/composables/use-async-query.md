...
Defined in: [src/runtime/nuxt/composables/use-async-query.ts:302](https://github.com/qruto/nuxt-convex-module/blob/main/src/runtime/nuxt/composables/use-async-query.ts#L302)
