...
// One active query subscription: identity and counters in the header, the
// latest result (or its error) and any server logs in the body.
defineProps<{ query: DevtoolsQuerySnapshot }>()
